...
static_assert FISHGROUP_STARYU == 15
static_assert FISHGROUP_CHINCHOU_SWARM == 16
static_assert FISHGROUP_SHELLDER_SWARM - FISHGROUP_CHINCHOU_SWARM + 1 == 7
