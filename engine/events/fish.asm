...
FishSwarmProfiles:
	...
	rept SWARM_PROFILE_QWILFISH
		db -1, -1
	endr
	db FISHGROUP_QWILFISH, FISHGROUP_QWILFISH_SWARM ; SWARM_PROFILE_QWILFISH
	rept SWARM_PROFILE_CHINCHOU - SWARM_PROFILE_QWILFISH - 1
		db -1, -1
	endr
	db FISHGROUP_SHORE, FISHGROUP_CHINCHOU_SWARM ; SWARM_PROFILE_CHINCHOU
	db FISHGROUP_POND, FISHGROUP_REMORAID_SWARM ; SWARM_PROFILE_REMORAID
	rept SWARM_PROFILE_HORSEA - SWARM_PROFILE_REMORAID - 1
		db -1, -1
	endr
	db FISHGROUP_STARYU, FISHGROUP_HORSEA_SWARM ; SWARM_PROFILE_HORSEA
	rept SWARM_PROFILE_DRATINI - SWARM_PROFILE_HORSEA - 1
		db -1, -1
	endr
	db FISHGROUP_DRATINI, FISHGROUP_DRATINI_SWARM ; SWARM_PROFILE_DRATINI
	rept SWARM_PROFILE_CORSOLA - SWARM_PROFILE_DRATINI - 1
		db -1, -1
	endr
	db FISHGROUP_SHORE, FISHGROUP_CORSOLA_SWARM ; SWARM_PROFILE_CORSOLA
	rept SWARM_PROFILE_MANTINE - SWARM_PROFILE_CORSOLA - 1
		db -1, -1
	endr
	db FISHGROUP_STARYU, FISHGROUP_MANTINE_SWARM ; SWARM_PROFILE_MANTINE
	rept SWARM_PROFILE_STARYU - SWARM_PROFILE_MANTINE - 1
		db -1, -1
	endr
	db FISHGROUP_SHORE, FISHGROUP_STARYU_SWARM ; SWARM_PROFILE_STARYU
	rept SWARM_PROFILE_SHELLDER - SWARM_PROFILE_STARYU - 1
		db -1, -1
	endr
	db FISHGROUP_OCEAN, FISHGROUP_SHELLDER_SWARM ; SWARM_PROFILE_SHELLDER
